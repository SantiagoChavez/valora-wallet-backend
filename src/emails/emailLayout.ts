...
/**
 * Logo de Valora embebido en base64 (34x34, mismo asset que el diseño de Claude Design).
 * Único lugar donde vive este blob — todos los templates de mail lo importan de acá.
 */
...
// Íconos (paths SVG, 24x24 viewBox) compartidos por los templates de mail. Los mockups
// originales no usaban el mismo ícono para filas con el mismo significado (ej. "Fecha" tenía
// un ícono en el mail de transferencias y otro distinto en el de compra) — acá se
// estandariza uno por significado para que las filas se vean consistentes entre todos los mails.
export const ICON_CART =
  '<circle cx="9" cy="20" r="1.4"></circle><circle cx="18" cy="20" r="1.4"></circle><path d="M3 4h2l2.4 12.2a1.6 1.6 0 0 0 1.6 1.3h8.6a1.6 1.6 0 0 0 1.6-1.3L21 8H6"></path>';
export const ICON_PLANE = '<path d="M21 3 3 10.5l7 3 3 7L21 3Z"></path>';
export const ICON_DOWN_ARROW =
  '<path d="M12 4v11"></path><path d="M7.5 11.5 12 16l4.5-4.5"></path><path d="M5 19h14"></path>';
export const ICON_CHECK = '<path d="M20 6 9 17l-5-5"></path>';
...
export const ROW_ICON_PERSON =
  '<circle cx="12" cy="8" r="3.5"></circle><path d="M5 20c0-3.5 3-6 7-6s7 2.5 7 6"></path>';
export const ROW_ICON_ALIAS =
  '<path d="M12 3v18"></path><path d="M6 8l-3 4 3 4"></path><path d="M18 8l3 4-3 4"></path>';
export const ROW_ICON_CLOCK = '<circle cx="12" cy="12" r="8.5"></circle><path d="M12 7.5V12l3 2"></path>';
export const ROW_ICON_DOCUMENT =
  '<rect x="5" y="4" width="14" height="16" rx="1.5"></rect><path d="M8 9h8M8 13h8M8 17h5"></path>';
export const ROW_ICON_MONEY =
  '<rect x="4" y="7" width="16" height="12" rx="2"></rect><path d="M4 10h16"></path><circle cx="15.5" cy="14.5" r="1"></circle>';
export const ROW_ICON_OPERATION =
  '<rect x="4" y="6" width="16" height="12" rx="2"></rect><circle cx="9" cy="12" r="1.7"></circle><path d="M13.5 10h3M13.5 14h3"></path>';
        ...
        <tr>
          <td style="padding:12px 0;border-top:1px solid #343531;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                <td width="20" style="vertical-align:middle;"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#9c8f7a" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${row.icon}</svg></td>
...
/** Ícono circular gold de 60x60 con el ícono de la acción (carrito, avión, flecha, etc.). */
export function renderIconBadge(iconPath: string): string {
  return `
  <tr>
    <td style="text-align:center;padding-bottom:20px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
        <tr><td width="60" height="60" align="center" valign="middle" style="width:60px;height:60px;border-radius:50%;border:1px solid #f0b429;background-color:#1b1c19;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#f0b429" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${iconPath}</svg></td></tr>
      </table>
    </td>
  </tr>`;
}
...
export function renderSuccessLine(text: string): string {
  ...
  <tr>
    <td style="padding:0 40px 28px 40px;text-align:center;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
        <tr>
          <td style="vertical-align:middle;padding-right:8px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#49dfa0" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">${ICON_CHECK}</svg></td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#050605;">
  ...
  <tr>
    <td style="padding:36px 40px 24px 40px;text-align:center;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
        <tr>
          <td style="padding-right:10px;vertical-align:middle;"><img src="data:image/png;base64,${VALORA_LOGO_BASE64}" width="34" height="34" alt="Valora" style="display:block;width:34px;height:34px;"></td>
  ...
  <tr>
    <td style="padding:24px 40px 36px 40px;text-align:center;border-top:1px solid #262624;">
      <div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:700;color:#f0b429;padding-bottom:6px;">Valora Wallet</div>
